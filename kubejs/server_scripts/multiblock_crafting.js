...
ServerEvents.recipes(event => {
  ...
  function EnergizingBlocks(catalyst, output, input){
    event.custom({
    type: "lychee:lightning_channeling",
    item_in: { item: catalyst },
    contextual:
    {
       type: "execute",
       command: `execute if block ~ ~-1 ~ ${input}`,
    },
    post: [
        {
          "type": "place",
  ...
  EnergizingBlocks("minecraft:blaze_powder","minecraft:iron_block","minecraft:copper_block")
