ServerEvents.recipes(e => {
 ...
 e.recipes.farmersdelight.cooking(["immersive_weathering:moss_clump","#forge:dusts/gold","#forge:dusts/gold","#forge:dusts/gold","#forge:dusts/gold","regions_unexplored:meadow_sage"],"immersive_weathering:golden_moss_clump",10,30).id("immersive_weathering:golden_moss_clump")
