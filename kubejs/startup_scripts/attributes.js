...
ForgeEvents.onEvent('net.minecraftforge.event.ItemAttributeModifierEvent', event => {
	...
	if (event.itemStack.hasTag("forge:tools/ironwood") && event.slotType == 'mainhand') {
		...
		event.addModifier("puffish_attributes:healing", new $AttributeModifier(UUID.fromString('c3a255ac-5cd6-4522-8d13-e9896465136e'), 'Tool modifier2', 0.5, 'addition'))
	};
	...
	if (event.itemStack.hasTag("forge:tools/steeleaf") && event.slotType == 'mainhand') {
		...
		event.addModifier("puffish_attributes:healing", new $AttributeModifier(UUID.fromString('6cd10078-a391-44f8-b803-a6973b9be8fb'), 'Tool modifier2', 0.5, 'addition'))
	};
